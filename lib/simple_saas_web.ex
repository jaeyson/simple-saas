defmodule SimpleSaasWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: SimpleSaasWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/simple_saas_web/templates",
        namespace: SimpleSaasWeb
      ...
      import SimpleSaasWeb.ErrorHelpers
      import SimpleSaasWeb.Gettext
      alias SimpleSaasWeb.Router.Helpers, as: Routes
    end
  end
